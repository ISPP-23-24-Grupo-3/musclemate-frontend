    ...
    <>
      ...
      <div className="flex flex-col space-y-3">
        <div className="flex gap-3">
          <input className="rounded border border-primary/50 w-1/2"></input>
          <Popover.Root>
            <Popover.Trigger className="p-2 flex-1 hover:border-primary">
              Sort
            </Popover.Trigger>
        ...
        <button className="flex items-center gap-2 font-bold px-3 hover:border-primary">
          <svg
        ...
        {MACHINES.map((machine) => {
          ...
          return (
            <button
              key={machine.id}
              className="flex bg-black/0 rounded-lg border-none shadow shadow-primary/30 p-3 justify-between hover:bg-primary/5 hover:shadow-primary/50 hover:border-none transition-all"
            >
