...
import lista from '../UserListing/lista.txt'
...
const Users = () => {
    ...
    return (
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', }}>
            ...
            onChange={e => setSearch(e.target.value)} style={busca}/>
        ...
        <ul>
            <li>
                <div style={{ ...index, display: 'flex', justifyContent: 'space-between', }}>
            ...
            {filteredUsers.map((user, index) => (
                <li key={index} style={listing}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', }}>
                        <Link to={"/users/"+user.id} style={name}>{user.name}</Link>
                        <div style={{...states, backgroundColor: user.state === 'Activa' 
                            ? '#E3D452' : '#ff8f8f'}}>{user.state}</div>
                    </div>
                </li>
            ))}
        </ul>
