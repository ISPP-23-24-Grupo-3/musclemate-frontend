...
export default function MailVerification() {
  ...
  const handleVerification = async (e) => {
    ...
    try {
      ...
      getFromApi(`users/verify/${user.username}/${token}/`).then((response) => {
  ...
  return (
    <>
      <Flex align="center" justify="center" direction="row">
        ...
        >
          Introduzca su token y haga click en el botón de abajo para verificar
          el e-mail de {user?.username}!
        </Heading>
      </Flex>
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-gray-500 bg-opacity-50">
          <div className="bg-white p-4 rounded-md shadow-md">
            <p className="text-red-600">
              Verificación de e-mail fallida. Por favor inténtelo de nuevo.
            </p>
            <Button
              onClick={closePopup}
              size="2"
